        ...
        <section className="relative overflow-hidden py-24 bg-[oklch(12.9%_0.042_264.695)] border-t border-white/5">
          ...
          <div className="container relative z-10 mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center mb-16">
              <p className="text-xs font-bold uppercase tracking-[0.35em] text-amber-500 mb-2">{copy.hero.title}</p>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    {"note" in section && section.note && (
                      <p className="text-sm text-slate-500 italic border-l-2 border-amber-500/30 pl-3">{section.note}</p>
                    )}
                    {"effective" in section && section.effective && (
                      <p className="text-sm text-slate-500 font-mono">{section.effective}</p>
                    )}
                  </MouseGlowCard>
                )
              })}
